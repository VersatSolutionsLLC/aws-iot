...
static void Handle_aws_Hibernate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_aws_IsInHibernation
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    switch (msgPtr->id)
    {
        ...
        case _MSGID_aws_Hibernate : Handle_aws_Hibernate(msgRef); break;
        case _MSGID_aws_IsInHibernation : Handle_aws_IsInHibernation(msgRef); break;
