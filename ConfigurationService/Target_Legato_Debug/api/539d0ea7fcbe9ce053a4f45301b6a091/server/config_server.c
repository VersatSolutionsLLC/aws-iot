...
static void Handle_config_GetString
(
...
static void Handle_config_GetInteger
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_config_GetFloat
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_config_GetBoolean
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    bool keyValueBuffer;
    bool *keyValuePtr = &keyValueBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        keyValuePtr = NULL;
    }
...
static void Handle_config_PutString
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_config_OpenFile
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_config_GetString : Handle_config_GetString(msgRef); break;
        case _MSGID_config_GetInteger : Handle_config_GetInteger(msgRef); break;
        case _MSGID_config_GetFloat : Handle_config_GetFloat(msgRef); break;
        case _MSGID_config_GetBoolean : Handle_config_GetBoolean(msgRef); break;
        case _MSGID_config_PutString : Handle_config_PutString(msgRef); break;
        case _MSGID_config_OpenFile : Handle_config_OpenFile(msgRef); break;
