...
// Startup code for the executable 'configuration'.
...
LE_SHARED const char* _Configuration_config_ServiceInstanceName = "config";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t configuration_exe_LogSession;
LE_SHARED le_log_Level_t* configuration_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    configuration_exe_LogSession = log_RegComponent("configuration_exe", &configuration_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_Configuration.so");
