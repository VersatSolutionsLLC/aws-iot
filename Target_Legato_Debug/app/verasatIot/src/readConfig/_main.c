...
// Startup code for the executable 'readConfig'.
...
LE_SHARED const char* _ReadConfig_config_ServiceInstanceName = "config";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t readConfig_exe_LogSession;
LE_SHARED le_log_Level_t* readConfig_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    readConfig_exe_LogSession = log_RegComponent("readConfig_exe", &readConfig_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_ReadConfig.so");
