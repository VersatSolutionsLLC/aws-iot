...
// Startup code for the executable 'publish'.
...
LE_SHARED le_log_Level_t* publish_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    publish_exe_LogSession = log_RegComponent("publish_exe", &publish_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_PublishRadio.so");
