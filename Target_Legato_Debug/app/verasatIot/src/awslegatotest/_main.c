...
// Startup code for the executable 'awslegatotest'.
...
LE_SHARED le_log_Level_t* awslegatotest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    awslegatotest_exe_LogSession = log_RegComponent("awslegatotest_exe", &awslegatotest_exe_LogLevelFilterPtr);
