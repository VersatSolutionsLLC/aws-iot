...
// Startup code for the executable 'gps'.
...
LE_SHARED const char* _Gps_gps_ServiceInstanceName = "gps.Gps.gps";
LE_SHARED const char* _Gps_le_gnss_ServiceInstanceName = "gps.Gps.le_gnss";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t gps_exe_LogSession;
LE_SHARED le_log_Level_t* gps_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    gps_exe_LogSession = log_RegComponent("gps_exe", &gps_exe_LogLevelFilterPtr);
