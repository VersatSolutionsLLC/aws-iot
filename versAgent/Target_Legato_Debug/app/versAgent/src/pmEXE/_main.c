...
// Startup code for the executable 'pmEXE'.
...
LE_SHARED const char* _PublishMetrics_aws_ServiceInstanceName = "pmEXE.PublishMetrics.aws";
LE_SHARED const char* _PublishMetrics_config_ServiceInstanceName = "pmEXE.PublishMetrics.config";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t pmEXE_exe_LogSession;
LE_SHARED le_log_Level_t* pmEXE_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    pmEXE_exe_LogSession = log_RegComponent("pmEXE_exe", &pmEXE_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_PublishMetrics.so");
